              ...
              <div className="flex-1 flex flex-col justify-between">
                <div className="spacey-6 mt-8">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center">
                        <CameraIcon className="h-5 w-5 text-primary text-blue-700" />
                      </div>
                      <div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center">
                        <MicIcon className="h-5 w-5 text-primary text-blue-700" />
                      </div>
                      <div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center">
                        <SettingsIcon className="h-5 w-5 text-primary text-blue-700" />
                      </div>
                      <div>
                ...
                <div className="space-y-3 mt-8">
                  <Button className="w-full bg-blue-700" size="lg" onClick={handleJoin}>
                    Join Meeting
                  </Button>
