...
function InterviewScheduleUI() {
  ...
  // Fetch interviews and users; default to empty arrays if not loaded yet.
  ...
  const scheduleMeeting = async () => {
    ...
    try {
      ...
      // Reset form data after scheduling
      setFormData({
        title: "",
        description: "",
        date: new Date(),
  ...
  const removeInterviewer = (interviewerId: string) => {
    // Prevent removal of the logged-in user from the list.
  ...
  // Filter interviewers that are selected and available based on their clerkId.
      ...
      <div className="flex items-center justify-between">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogTrigger asChild>
            <Button className="bg-blue-700" size="lg">Schedule Interview</Button>
          </DialogTrigger>
